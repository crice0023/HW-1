...
This graph represents all countries involved in the raw dataset and shows the rise in COVID-19 cases over time. The scale was maniputed taking the log of cases (cases/population * 100000).
